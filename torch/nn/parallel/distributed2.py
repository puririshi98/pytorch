...
class DistributedDataParallel(Module):
        ...
        try:
            ...
            if enable and not has_error:
                ...
                while not all_procs_joined:
                    ...
                    print("running self._schedule_shadow_all_reduce_for_fwd_pass()")
                    ...
                    if num_active_procs == 0:
                        ...
                        if self.ddp_uneven_inputs_config.ddp_join_throw_on_early_termination:
                            ...
                            ones = torch.ones(1, device=self.device)
                            print("all reducing through dist")
    ...
    def _find_common_rank(self, input_rank, rank_cond):
        ...
        print("find common rank all reduce")
